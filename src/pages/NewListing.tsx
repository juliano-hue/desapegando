...
export default function NewListing() {
  ...
  async function publish() {
    ...
    const r = await apiFetch<{ listing: Listing }>('/api/listings', {
      method: 'POST',
      json: {
        title,
        description,
      ...
      <div className="mx-auto grid max-w-3xl gap-5">
        <section className="rounded-3xl border border-white/10 bg-white/5 p-5 md:p-6">
          <div className="flex items-end justify-between gap-3">
            <div>
              <div className="text-sm text-slate-300">Anunciar</div>
              <h1 className="mt-1 text-2xl font-semibold tracking-tight">Crie seu anúncio</h1>
              <p className="mt-2 text-sm text-slate-300">Em 2 passos: detalhes e fotos.</p>
            </div>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="grid gap-2">
                  ...
                  <select
                    ...
                    className="h-11 w-full rounded-xl border border-white/10 bg-white/6 px-3 text-sm text-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/70 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                  >
                ...
                <div className="grid gap-2">
                  ...
                  <select
                    ...
                    className="h-11 w-full rounded-xl border border-white/10 bg-white/6 px-3 text-sm text-slate-50 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/70 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                  >
                    <option value="">Selecione…</option>
        ...
        {step === 2 ? (
          <section className="rounded-3xl border border-white/10 bg-white/5 p-5 md:p-6">
            ...
            <p className="mt-2 text-sm text-slate-300">
              Use até 8 fotos. As imagens carregam de forma assíncrona.
            </p>
